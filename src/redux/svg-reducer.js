...
let initialState = {
    paths: [
        {
            id:1,
            path: <path
                d="M1689 12788 c-59 -16 -1570 -912 -1598 -947 -13 -17 -32 -62 -43 -99
    ...
    60 -208 120 -239 135 -109 50 -202 63 -285 41z"/>,
        ...
        {id: 2,
            path: <path d="M5595 12791 c-45 -11 -46 -12 -830 -473 -401 -237 -745 -445 -763
    ...
    -1312 778 -1438 850 -120 68 -240 94 -330 73z"/>,
            ...
            fill: "rgb(136, 136, 136)"
                ...
                {
            id:3,
            path: <path d="M9479 12788 c-21 -5 -383 -213 -805 -463 -844 -497 -808 -472 -839
    ...
    170 -607 359 -707 419 -101 60 -208 120 -239 135 -110 50 -202 63 -285 41z"/>,
        ...
        {
            id:4,
            path: <path d="M1660 8411 c-66 -27 -1520 -888 -1552 -918 -39 -37 -66 -117 -78
    ...
    -41 422 -93 466 -37 32 -1488 883 -1548 908 -82 34 -210 40 -276 12z"/>,
        ...
        {
            id:5,
            path: <path d="M5545 8407 c-53 -25 -1479 -865 -1529 -900 -36 -26 -72 -104 -85
    ...
    542 -1044 547 -79 4 -96 1 -140 -20z"/>,
        ...
        {
            id:6,
            path: <path d="M9450 8411 c-59 -24 -1518 -886 -1548 -914 -68 -63 -81 -134 -93
    ...
    34 -210 40 -276 12z"/>,
        ...
        {
            id:7 ,
            path: <path d="M1688 4058 c-60 -16 -1569 -911 -1597 -947 -13 -17 -32 -62 -43 -99
    ...
    -233 87 -327 62z"/>,
        ...
        {id:8,
            path: <path d="M5579 4056 c-49 -17 -52 -19 -849 -488 -440 -260 -708 -423 -731
    ...
    39 -189 47 -256 23z"/>,
        ...
        {id:9,
            path: <path d="M9478 4058 c-20 -5 -383 -214 -805 -463 -843 -497 -807 -471 -838
    -590 -21 -76 -32 -404 -41 -1170 -7 -652 -1 -783 41 -847 40 -61 128 -122 300
